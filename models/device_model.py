...
class Device(db.Model):
    ...
    distance_field = db.Column(db.String(10), nullable=True)  # ThingSpeak field number for distance
    temperature_field = db.Column(db.String(10), nullable=True)  # ThingSpeak field number for temperature
    ...
    meter_reading_field = db.Column(db.String(10), nullable=True)  # ThingSpeak field for meter reading
    flow_rate_field = db.Column(db.String(10), nullable=True)  # ThingSpeak field for flow rate
    
    # EvaraValve specific fields
    liters_field = db.Column(db.String(10), nullable=True)  # ThingSpeak field for liters
    ...
    tds_field = db.Column(db.String(10), nullable=True)  # ThingSpeak field for TDS in ppm
    ...
    processed_data = db.relationship('ProcessedData', backref='device', lazy=True, cascade='all, delete-orphan')
