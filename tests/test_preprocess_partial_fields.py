...
def test_evaraflow_partial_fields():
    ...
    feeds = [
        {'entry_id': '1', 'created_at': '2026-07-11T12:00:00Z', 'field3': '100.5', 'field2': '1.2'},
        {'entry_id': '2', 'created_at': '2026-07-11T12:01:00Z', 'field3': '101.2', 'field2': None},
        {'entry_id': '3', 'created_at': '2026-07-11T12:02:00Z', 'field3': None, 'field2': '1.5'},
...
def test_evaratank_partial_fields():
    ...
    feeds = [
        {'entry_id': '1', 'created_at': '2026-07-11T12:00:00Z', 'field1': '50', 'field2': '25'},
        {'entry_id': '2', 'created_at': '2026-07-11T12:01:00Z', 'field1': '60', 'field2': None},
...
def test_filters_with_none():
    ...
    assert median_filtered[2] == 2.5  # window [None, 2.0, 3.0] -> non-none [2.0, 3.0] -> median 2.5
    ...
    assert avg_filtered[2] == 2.5     # window [None, 2.0, 3.0] -> non-none [2.0, 3.0] -> average 2.5
