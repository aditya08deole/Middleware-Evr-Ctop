...
class TestEMQXTestConnectionRoute(unittest.TestCase):
    ...
    def test_already_connected_reports_success_without_resubscribing(
    ...
    @patch.object(local_device_store, "get_device_by_id", return_value=EMQX_DEVICE)
    def test_not_connected_but_acks_within_poll_window_reports_success(
        self, mock_get_device
    ):
        mock_emqx = MagicMock()
        ...
        with patch.object(scheduler_mod, "emqx_service", mock_emqx), patch(
